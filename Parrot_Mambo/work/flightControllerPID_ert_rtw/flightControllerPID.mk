###########################################################################
## Makefile generated for Simulink model 'flightControllerPID'. 
## 
## Makefile     : flightControllerPID.mk
## Generated on : Fri May 24 09:43:27 2019
## MATLAB Coder version: 4.2 (R2019a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/flightControllerPID.so
...
PRODUCT_NAME              = flightControllerPID
MAKEFILE                  = flightControllerPID.mk
COMPUTER                  = GLNXA64
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/flightControllerPID.so
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(START_DIR)/flightControllerPID_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I/home/cerlabcontrol/Documents/MATLAB/SupportPackages/R2019a/toolbox/target/supportpackages/parrot/include
...
DEFINES_ = -DMODEL=flightControllerPID -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0 -DUNIX -DCLASSIC_INTERFACE=0 -DALLOCATIONFCN=0 -DTID01EQ=0 -DTERMFCN=1 -DONESTEPFCN=1 -DMAT_FILE=0 -DMULTI_INSTANCE_CODE=0 -DINTEGER_CODE=0 -DMT=0 -DDELOS -DDELOS_EDU -DEXTMODE_DISABLETESTING -DEXTMODE_STATIC_SIZE=16384 -DEXTMODE_DISABLE_ARGS_PROCESSING=1 -DPARROT_LINUX_COMM -DSTACK_SIZE=64 -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DRT -DSTOP_TIME=30 -DMAMBO=1
...
DEFINES_STANDARD = -DMODEL=flightControllerPID -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0 -DUNIX
...
SRCS = $(START_DIR)/flightControllerPID_ert_rtw/flightControllerPID.c $(START_DIR)/flightControllerPID_ert_rtw/flightControllerPID_data.c /home/cerlabcontrol/Documents/MATLAB/SupportPackages/R2019a/toolbox/target/supportpackages/parrot/src/rsedu_control.c /home/cerlabcontrol/Documents/MATLAB/SupportPackages/R2019a/toolbox/target/supportpackages/parrot/src/rsedu_of.c /home/cerlabcontrol/Documents/MATLAB/SupportPackages/R2019a/toolbox/target/supportpackages/parrot/src/rsedu_vis.c /home/cerlabcontrol/Documents/MATLAB/SupportPackages/R2019a/toolbox/target/supportpackages/parrot/src/ptimer.c /home/cerlabcontrol/Documents/MATLAB/SupportPackages/R2019a/toolbox/target/supportpackages/parrot/src/controlCommand.c /home/cerlabcontrol/Documents/MATLAB/SupportPackages/R2019a/toolbox/target/supportpackages/parrot/src/mw_extrathreads.c
...
OBJS = flightControllerPID.o flightControllerPID_data.o rsedu_control.o rsedu_of.o rsedu_vis.o ptimer.o controlCommand.o mw_extrathreads.o
...
%.o : $(START_DIR)/flightControllerPID_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/flightControllerPID_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
