 ...
 *
 * File: communicationFlightControlSystem_types.h
 *
...
#ifndef RTW_HEADER_communicationFlightControlSystem_types_h_
#define RTW_HEADER_communicationFlightControlSystem_types_h_
#include "rtwtypes.h"
...
#ifndef typedef_parrot_TCPReceive_communicationFlightControlSystem_T
#define typedef_parrot_TCPReceive_communicationFlightControlSystem_T
...
} parrot_TCPReceive_communicationFlightControlSystem_T;

#endif          /*typedef_parrot_TCPReceive_communicationFlightControlSystem_T*/

/* Parameters for system: '<S4>/Geofencing error' */
typedef struct P_Geofencingerror_communicationFlightControlSystem_T_
  P_Geofencingerror_communicationFlightControlSystem_T;

/* Parameters for system: '<Root>/Flight Control System' */
typedef struct P_FlightControlSystem_communicationFlightControlSystem_T_
  P_FlightControlSystem_communicationFlightControlSystem_T;

/* Parameters (default storage) */
typedef struct P_communicationFlightControlSystem_T_
  P_communicationFlightControlSystem_T;

/* Forward declaration for rtModel */
typedef struct tag_RTM_communicationFlightControlSystem_T
  RT_MODEL_communicationFlightControlSystem_T;

#endif                /* RTW_HEADER_communicationFlightControlSystem_types_h_ */
