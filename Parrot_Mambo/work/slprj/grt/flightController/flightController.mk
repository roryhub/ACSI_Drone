...
## Generated on : Wed May 22 13:06:16 2019
...
DEFINES_STANDARD = -DMODEL=flightController -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DRT -DUSE_RTMODEL -DUNIX
...
%.o : $(START_DIR)/slprj/grt/flightController/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/slprj/grt/flightController/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
