...
## Generated on : Wed May 22 13:06:22 2019
...
DEFINES_STANDARD = -DMODEL=stateEstimator -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DRT -DUSE_RTMODEL -DUNIX
...
OBJS = stateEstimator.o stateEstimator_data.o
...
%.o : $(START_DIR)/slprj/grt/stateEstimator/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/slprj/grt/stateEstimator/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
