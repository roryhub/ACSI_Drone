...
static void cgxe_mdl_start(InstanceStruct_MzC2xl4HWRKP1Dkswc00K *moduleInstance);
static void cgxe_mdl_initialize(InstanceStruct_MzC2xl4HWRKP1Dkswc00K
  *moduleInstance);
static void cgxe_mdl_outputs(InstanceStruct_MzC2xl4HWRKP1Dkswc00K
  *moduleInstance);
static void cgxe_mdl_update(InstanceStruct_MzC2xl4HWRKP1Dkswc00K *moduleInstance);
static void cgxe_mdl_enable(InstanceStruct_MzC2xl4HWRKP1Dkswc00K *moduleInstance);
static void cgxe_mdl_disable(InstanceStruct_MzC2xl4HWRKP1Dkswc00K
  *moduleInstance);
static void cgxe_mdl_terminate(InstanceStruct_MzC2xl4HWRKP1Dkswc00K
  *moduleInstance);
static void mw__internal__call__setup(InstanceStruct_MzC2xl4HWRKP1Dkswc00K
  *moduleInstance, const emlrtStack *sp);
static void mw__internal__call__reset(InstanceStruct_MzC2xl4HWRKP1Dkswc00K
  *moduleInstance, const emlrtStack *sp);
static void mw__internal__call__step(InstanceStruct_MzC2xl4HWRKP1Dkswc00K
  *moduleInstance, const emlrtStack *sp, real32_T *c_y0, uint8_T *c_y1);
static const mxArray *emlrt_marshallOut(InstanceStruct_MzC2xl4HWRKP1Dkswc00K
  *moduleInstance);
static const mxArray *cgxe_mdl_get_sim_state
  (InstanceStruct_MzC2xl4HWRKP1Dkswc00K *moduleInstance);
static void emlrt_marshallIn(InstanceStruct_MzC2xl4HWRKP1Dkswc00K
...
static void cgxe_mdl_set_sim_state(InstanceStruct_MzC2xl4HWRKP1Dkswc00K
...
static boolean_T h_emlrt_marshallIn(const emlrtStack *sp, const mxArray *src,
  const emlrtMsgIdentifier *msgId);
static void init_simulink_io_address(InstanceStruct_MzC2xl4HWRKP1Dkswc00K
  *moduleInstance);
...
/* CGXE Glue Code */
static void mdlOutputs_MzC2xl4HWRKP1Dkswc00K(SimStruct *S, int_T tid)
{
  InstanceStruct_MzC2xl4HWRKP1Dkswc00K *moduleInstance =
    (InstanceStruct_MzC2xl4HWRKP1Dkswc00K *)cgxertGetRuntimeInstance(S);
  cgxe_mdl_outputs(moduleInstance);
}

static void mdlInitialize_MzC2xl4HWRKP1Dkswc00K(SimStruct *S)
{
  InstanceStruct_MzC2xl4HWRKP1Dkswc00K *moduleInstance =
    (InstanceStruct_MzC2xl4HWRKP1Dkswc00K *)cgxertGetRuntimeInstance(S);
...
static void mdlUpdate_MzC2xl4HWRKP1Dkswc00K(SimStruct *S, int_T tid)
{
  InstanceStruct_MzC2xl4HWRKP1Dkswc00K *moduleInstance =
    (InstanceStruct_MzC2xl4HWRKP1Dkswc00K *)cgxertGetRuntimeInstance(S);
...
static mxArray* getSimState_MzC2xl4HWRKP1Dkswc00K(SimStruct *S)
{
  mxArray* mxSS;
  InstanceStruct_MzC2xl4HWRKP1Dkswc00K *moduleInstance =
    (InstanceStruct_MzC2xl4HWRKP1Dkswc00K *)cgxertGetRuntimeInstance(S);
...
static void setSimState_MzC2xl4HWRKP1Dkswc00K(SimStruct *S, const mxArray *ss)
{
  InstanceStruct_MzC2xl4HWRKP1Dkswc00K *moduleInstance =
    (InstanceStruct_MzC2xl4HWRKP1Dkswc00K *)cgxertGetRuntimeInstance(S);
...
static void mdlTerminate_MzC2xl4HWRKP1Dkswc00K(SimStruct *S)
{
  InstanceStruct_MzC2xl4HWRKP1Dkswc00K *moduleInstance =
    (InstanceStruct_MzC2xl4HWRKP1Dkswc00K *)cgxertGetRuntimeInstance(S);
...
static void mdlEnable_MzC2xl4HWRKP1Dkswc00K(SimStruct *S)
{
  InstanceStruct_MzC2xl4HWRKP1Dkswc00K *moduleInstance =
    (InstanceStruct_MzC2xl4HWRKP1Dkswc00K *)cgxertGetRuntimeInstance(S);
...
static void mdlDisable_MzC2xl4HWRKP1Dkswc00K(SimStruct *S)
{
  InstanceStruct_MzC2xl4HWRKP1Dkswc00K *moduleInstance =
    (InstanceStruct_MzC2xl4HWRKP1Dkswc00K *)cgxertGetRuntimeInstance(S);
...
static void mdlStart_MzC2xl4HWRKP1Dkswc00K(SimStruct *S)
{
  InstanceStruct_MzC2xl4HWRKP1Dkswc00K *moduleInstance =
    (InstanceStruct_MzC2xl4HWRKP1Dkswc00K *)calloc(1, sizeof
    (InstanceStruct_MzC2xl4HWRKP1Dkswc00K));
  moduleInstance->S = S;
  cgxertSetRuntimeInstance(S, (void *)moduleInstance);
  ssSetmdlOutputs(S, mdlOutputs_MzC2xl4HWRKP1Dkswc00K);
  ssSetmdlInitializeConditions(S, mdlInitialize_MzC2xl4HWRKP1Dkswc00K);
  ssSetmdlUpdate(S, mdlUpdate_MzC2xl4HWRKP1Dkswc00K);
  ssSetmdlTerminate(S, mdlTerminate_MzC2xl4HWRKP1Dkswc00K);
  ssSetmdlEnable(S, mdlEnable_MzC2xl4HWRKP1Dkswc00K);
  ssSetmdlDisable(S, mdlDisable_MzC2xl4HWRKP1Dkswc00K);
...
static void mdlProcessParameters_MzC2xl4HWRKP1Dkswc00K(SimStruct *S)
{
}

void method_dispatcher_MzC2xl4HWRKP1Dkswc00K(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_MzC2xl4HWRKP1Dkswc00K(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_MzC2xl4HWRKP1Dkswc00K(S);
    break;

   case SS_CALL_MDL_GET_SIM_STATE:
    *((mxArray**) data) = getSimState_MzC2xl4HWRKP1Dkswc00K(S);
    break;

   case SS_CALL_MDL_SET_SIM_STATE:
    setSimState_MzC2xl4HWRKP1Dkswc00K(S, (const mxArray *) data);
    break;
   ...
   default:
    ...
    /*
       ...
       "Error calling method dispatcher for module: MzC2xl4HWRKP1Dkswc00K.\n"
...
mxArray *cgxe_MzC2xl4HWRKP1Dkswc00K_BuildInfoUpdate(void)
{
  mxArray * mxBIArgs;
  mxArray * elem_1;
  mxArray * elem_2;
...
mxArray *cgxe_MzC2xl4HWRKP1Dkswc00K_fallback_info(void)
{
