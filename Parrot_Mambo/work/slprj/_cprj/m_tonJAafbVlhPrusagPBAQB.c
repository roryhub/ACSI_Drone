...
#include "m_tonJAafbVlhPrusagPBAQB.h"
...
static void cgxe_mdl_start(InstanceStruct_tonJAafbVlhPrusagPBAQB *moduleInstance);
static void cgxe_mdl_initialize(InstanceStruct_tonJAafbVlhPrusagPBAQB
  *moduleInstance);
static void cgxe_mdl_outputs(InstanceStruct_tonJAafbVlhPrusagPBAQB
  *moduleInstance);
static void cgxe_mdl_update(InstanceStruct_tonJAafbVlhPrusagPBAQB
  *moduleInstance);
static void cgxe_mdl_enable(InstanceStruct_tonJAafbVlhPrusagPBAQB
  *moduleInstance);
static void cgxe_mdl_disable(InstanceStruct_tonJAafbVlhPrusagPBAQB
  *moduleInstance);
static void cgxe_mdl_terminate(InstanceStruct_tonJAafbVlhPrusagPBAQB
  *moduleInstance);
static void mw__internal__call__setup(InstanceStruct_tonJAafbVlhPrusagPBAQB
  *moduleInstance, const emlrtStack *sp);
static void mw__internal__call__reset(InstanceStruct_tonJAafbVlhPrusagPBAQB
  *moduleInstance, const emlrtStack *sp);
static void mw__internal__call__step(InstanceStruct_tonJAafbVlhPrusagPBAQB
  *moduleInstance, const emlrtStack *sp, real32_T *c_y0, uint8_T *c_y1);
static const mxArray *emlrt_marshallOut(InstanceStruct_tonJAafbVlhPrusagPBAQB
  *moduleInstance);
static const mxArray *cgxe_mdl_get_sim_state
  (InstanceStruct_tonJAafbVlhPrusagPBAQB *moduleInstance);
static void emlrt_marshallIn(InstanceStruct_tonJAafbVlhPrusagPBAQB
...
static void cgxe_mdl_set_sim_state(InstanceStruct_tonJAafbVlhPrusagPBAQB
...
static boolean_T h_emlrt_marshallIn(const emlrtStack *sp, const mxArray *src,
  const emlrtMsgIdentifier *msgId);
static void init_simulink_io_address(InstanceStruct_tonJAafbVlhPrusagPBAQB
  *moduleInstance);
...
/* CGXE Glue Code */
static void mdlOutputs_tonJAafbVlhPrusagPBAQB(SimStruct *S, int_T tid)
{
  InstanceStruct_tonJAafbVlhPrusagPBAQB *moduleInstance =
    (InstanceStruct_tonJAafbVlhPrusagPBAQB *)cgxertGetRuntimeInstance(S);
  cgxe_mdl_outputs(moduleInstance);
}

static void mdlInitialize_tonJAafbVlhPrusagPBAQB(SimStruct *S)
{
  InstanceStruct_tonJAafbVlhPrusagPBAQB *moduleInstance =
    (InstanceStruct_tonJAafbVlhPrusagPBAQB *)cgxertGetRuntimeInstance(S);
...
static void mdlUpdate_tonJAafbVlhPrusagPBAQB(SimStruct *S, int_T tid)
{
  InstanceStruct_tonJAafbVlhPrusagPBAQB *moduleInstance =
    (InstanceStruct_tonJAafbVlhPrusagPBAQB *)cgxertGetRuntimeInstance(S);
...
static mxArray* getSimState_tonJAafbVlhPrusagPBAQB(SimStruct *S)
{
  mxArray* mxSS;
  InstanceStruct_tonJAafbVlhPrusagPBAQB *moduleInstance =
    (InstanceStruct_tonJAafbVlhPrusagPBAQB *)cgxertGetRuntimeInstance(S);
...
static void setSimState_tonJAafbVlhPrusagPBAQB(SimStruct *S, const mxArray *ss)
{
  InstanceStruct_tonJAafbVlhPrusagPBAQB *moduleInstance =
    (InstanceStruct_tonJAafbVlhPrusagPBAQB *)cgxertGetRuntimeInstance(S);
...
static void mdlTerminate_tonJAafbVlhPrusagPBAQB(SimStruct *S)
{
  InstanceStruct_tonJAafbVlhPrusagPBAQB *moduleInstance =
    (InstanceStruct_tonJAafbVlhPrusagPBAQB *)cgxertGetRuntimeInstance(S);
...
static void mdlEnable_tonJAafbVlhPrusagPBAQB(SimStruct *S)
{
  InstanceStruct_tonJAafbVlhPrusagPBAQB *moduleInstance =
    (InstanceStruct_tonJAafbVlhPrusagPBAQB *)cgxertGetRuntimeInstance(S);
...
static void mdlDisable_tonJAafbVlhPrusagPBAQB(SimStruct *S)
{
  InstanceStruct_tonJAafbVlhPrusagPBAQB *moduleInstance =
    (InstanceStruct_tonJAafbVlhPrusagPBAQB *)cgxertGetRuntimeInstance(S);
...
static void mdlStart_tonJAafbVlhPrusagPBAQB(SimStruct *S)
{
  InstanceStruct_tonJAafbVlhPrusagPBAQB *moduleInstance =
    (InstanceStruct_tonJAafbVlhPrusagPBAQB *)calloc(1, sizeof
    (InstanceStruct_tonJAafbVlhPrusagPBAQB));
  moduleInstance->S = S;
  cgxertSetRuntimeInstance(S, (void *)moduleInstance);
  ssSetmdlOutputs(S, mdlOutputs_tonJAafbVlhPrusagPBAQB);
  ssSetmdlInitializeConditions(S, mdlInitialize_tonJAafbVlhPrusagPBAQB);
  ssSetmdlUpdate(S, mdlUpdate_tonJAafbVlhPrusagPBAQB);
  ssSetmdlTerminate(S, mdlTerminate_tonJAafbVlhPrusagPBAQB);
  ssSetmdlEnable(S, mdlEnable_tonJAafbVlhPrusagPBAQB);
  ssSetmdlDisable(S, mdlDisable_tonJAafbVlhPrusagPBAQB);
...
static void mdlProcessParameters_tonJAafbVlhPrusagPBAQB(SimStruct *S)
{
}

void method_dispatcher_tonJAafbVlhPrusagPBAQB(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_tonJAafbVlhPrusagPBAQB(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_tonJAafbVlhPrusagPBAQB(S);
    break;

   case SS_CALL_MDL_GET_SIM_STATE:
    *((mxArray**) data) = getSimState_tonJAafbVlhPrusagPBAQB(S);
    break;

   case SS_CALL_MDL_SET_SIM_STATE:
    setSimState_tonJAafbVlhPrusagPBAQB(S, (const mxArray *) data);
    break;
   ...
   default:
    ...
    /*
       ...
       "Error calling method dispatcher for module: tonJAafbVlhPrusagPBAQB.\n"
...
mxArray *cgxe_tonJAafbVlhPrusagPBAQB_BuildInfoUpdate(void)
{
  mxArray * mxBIArgs;
  mxArray * elem_1;
  mxArray * elem_2;
...
mxArray *cgxe_tonJAafbVlhPrusagPBAQB_fallback_info(void)
{
