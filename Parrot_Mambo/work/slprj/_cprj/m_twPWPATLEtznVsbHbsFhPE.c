...
#include "m_twPWPATLEtznVsbHbsFhPE.h"
...
static emlrtRSInfo k_emlrtRSI = { 29,  /* lineNo */
  "",                                  /* fcnName */
  ""                                   /* pathName */
};
...
static void cgxe_mdl_start(InstanceStruct_twPWPATLEtznVsbHbsFhPE *moduleInstance);
static void cgxe_mdl_initialize(InstanceStruct_twPWPATLEtznVsbHbsFhPE
  *moduleInstance);
static void cgxe_mdl_outputs(InstanceStruct_twPWPATLEtznVsbHbsFhPE
  *moduleInstance);
static void cgxe_mdl_update(InstanceStruct_twPWPATLEtznVsbHbsFhPE
  *moduleInstance);
static void cgxe_mdl_enable(InstanceStruct_twPWPATLEtznVsbHbsFhPE
  *moduleInstance);
static void cgxe_mdl_disable(InstanceStruct_twPWPATLEtznVsbHbsFhPE
  *moduleInstance);
static void cgxe_mdl_terminate(InstanceStruct_twPWPATLEtznVsbHbsFhPE
  *moduleInstance);
static void mw__internal__call__setup(InstanceStruct_twPWPATLEtznVsbHbsFhPE
  *moduleInstance, const emlrtStack *sp);
static void mw__internal__call__reset(InstanceStruct_twPWPATLEtznVsbHbsFhPE
  *moduleInstance, const emlrtStack *sp);
static void mw__internal__call__step(InstanceStruct_twPWPATLEtznVsbHbsFhPE
  *moduleInstance, const emlrtStack *sp, real32_T c_y0[3], uint8_T *c_y1);
static const mxArray *emlrt_marshallOut(InstanceStruct_twPWPATLEtznVsbHbsFhPE
  *moduleInstance);
static const mxArray *cgxe_mdl_get_sim_state
  (InstanceStruct_twPWPATLEtznVsbHbsFhPE *moduleInstance);
static void emlrt_marshallIn(InstanceStruct_twPWPATLEtznVsbHbsFhPE
...
static void cgxe_mdl_set_sim_state(InstanceStruct_twPWPATLEtznVsbHbsFhPE
...
static boolean_T h_emlrt_marshallIn(const emlrtStack *sp, const mxArray *src,
  const emlrtMsgIdentifier *msgId);
static void init_simulink_io_address(InstanceStruct_twPWPATLEtznVsbHbsFhPE
  *moduleInstance);
...
/* CGXE Glue Code */
static void mdlOutputs_twPWPATLEtznVsbHbsFhPE(SimStruct *S, int_T tid)
{
  InstanceStruct_twPWPATLEtznVsbHbsFhPE *moduleInstance =
    (InstanceStruct_twPWPATLEtznVsbHbsFhPE *)cgxertGetRuntimeInstance(S);
  cgxe_mdl_outputs(moduleInstance);
}

static void mdlInitialize_twPWPATLEtznVsbHbsFhPE(SimStruct *S)
{
  InstanceStruct_twPWPATLEtznVsbHbsFhPE *moduleInstance =
    (InstanceStruct_twPWPATLEtznVsbHbsFhPE *)cgxertGetRuntimeInstance(S);
...
static void mdlUpdate_twPWPATLEtznVsbHbsFhPE(SimStruct *S, int_T tid)
{
  InstanceStruct_twPWPATLEtznVsbHbsFhPE *moduleInstance =
    (InstanceStruct_twPWPATLEtznVsbHbsFhPE *)cgxertGetRuntimeInstance(S);
...
static mxArray* getSimState_twPWPATLEtznVsbHbsFhPE(SimStruct *S)
{
  mxArray* mxSS;
  InstanceStruct_twPWPATLEtznVsbHbsFhPE *moduleInstance =
    (InstanceStruct_twPWPATLEtznVsbHbsFhPE *)cgxertGetRuntimeInstance(S);
...
static void setSimState_twPWPATLEtznVsbHbsFhPE(SimStruct *S, const mxArray *ss)
{
  InstanceStruct_twPWPATLEtznVsbHbsFhPE *moduleInstance =
    (InstanceStruct_twPWPATLEtznVsbHbsFhPE *)cgxertGetRuntimeInstance(S);
...
static void mdlTerminate_twPWPATLEtznVsbHbsFhPE(SimStruct *S)
{
  InstanceStruct_twPWPATLEtznVsbHbsFhPE *moduleInstance =
    (InstanceStruct_twPWPATLEtznVsbHbsFhPE *)cgxertGetRuntimeInstance(S);
...
static void mdlEnable_twPWPATLEtznVsbHbsFhPE(SimStruct *S)
{
  InstanceStruct_twPWPATLEtznVsbHbsFhPE *moduleInstance =
    (InstanceStruct_twPWPATLEtznVsbHbsFhPE *)cgxertGetRuntimeInstance(S);
...
static void mdlDisable_twPWPATLEtznVsbHbsFhPE(SimStruct *S)
{
  InstanceStruct_twPWPATLEtznVsbHbsFhPE *moduleInstance =
    (InstanceStruct_twPWPATLEtznVsbHbsFhPE *)cgxertGetRuntimeInstance(S);
...
static void mdlStart_twPWPATLEtznVsbHbsFhPE(SimStruct *S)
{
  InstanceStruct_twPWPATLEtznVsbHbsFhPE *moduleInstance =
    (InstanceStruct_twPWPATLEtznVsbHbsFhPE *)calloc(1, sizeof
    (InstanceStruct_twPWPATLEtznVsbHbsFhPE));
  moduleInstance->S = S;
  cgxertSetRuntimeInstance(S, (void *)moduleInstance);
  ssSetmdlOutputs(S, mdlOutputs_twPWPATLEtznVsbHbsFhPE);
  ssSetmdlInitializeConditions(S, mdlInitialize_twPWPATLEtznVsbHbsFhPE);
  ssSetmdlUpdate(S, mdlUpdate_twPWPATLEtznVsbHbsFhPE);
  ssSetmdlTerminate(S, mdlTerminate_twPWPATLEtznVsbHbsFhPE);
  ssSetmdlEnable(S, mdlEnable_twPWPATLEtznVsbHbsFhPE);
  ssSetmdlDisable(S, mdlDisable_twPWPATLEtznVsbHbsFhPE);
...
static void mdlProcessParameters_twPWPATLEtznVsbHbsFhPE(SimStruct *S)
{
}

void method_dispatcher_twPWPATLEtznVsbHbsFhPE(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_twPWPATLEtznVsbHbsFhPE(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_twPWPATLEtznVsbHbsFhPE(S);
    break;

   case SS_CALL_MDL_GET_SIM_STATE:
    *((mxArray**) data) = getSimState_twPWPATLEtznVsbHbsFhPE(S);
    break;

   case SS_CALL_MDL_SET_SIM_STATE:
    setSimState_twPWPATLEtznVsbHbsFhPE(S, (const mxArray *) data);
    break;
   ...
   default:
    ...
    /*
       ...
       "Error calling method dispatcher for module: twPWPATLEtznVsbHbsFhPE.\n"
...
mxArray *cgxe_twPWPATLEtznVsbHbsFhPE_BuildInfoUpdate(void)
{
  mxArray * mxBIArgs;
  mxArray * elem_1;
  mxArray * elem_2;
...
mxArray *cgxe_twPWPATLEtznVsbHbsFhPE_fallback_info(void)
{
