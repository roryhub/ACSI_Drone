...
## Generated on : Mon Jun 03 11:24:37 2019
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(START_DIR)/slprj/ert/_sharedutils -I/home/cerlabcontrol/Documents/MATLAB/SupportPackages/R2019a/toolbox/target/supportpackages/shared_linuxservices/include -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(MATLAB_ROOT)/toolbox/vision/include -I$(MATLAB_ROOT)/toolbox/shared/dsp/vision/matlab/include -I/home/cerlabcontrol/Documents/MATLAB/SupportPackages/R2019a/toolbox/target/supportpackages/parrot/include -I$(MATLAB_ROOT)/toolbox/shared/spc/src_ml/extern/include
...
DEFINES_ = -DMODEL=flightControlSystem -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0 -DUNIX -DCLASSIC_INTERFACE=0 -DALLOCATIONFCN=0 -DTID01EQ=0 -DTERMFCN=1 -DONESTEPFCN=1 -DMAT_FILE=1 -DMULTI_INSTANCE_CODE=0 -DINTEGER_CODE=0 -DMT=1 -DDELOS -DDELOS_EDU -DEXTMODE_DISABLETESTING -DEXTMODE_STATIC_SIZE=16384 -DEXTMODE_DISABLE_ARGS_PROCESSING=1 -DPARROT_LINUX_COMM -DSTACK_SIZE=64 -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DRT -DMATFILE_LOGGING=1 -DMW_HAS_IMAGE_PROCESSING -DSTOP_TIME=30 -DMAMBO=1 -D_USE_TARGET_UDP_
...
SRCS = $(START_DIR)/slprj/ert/_sharedutils/const_params.c $(START_DIR)/slprj/ert/_sharedutils/rtGetInf.c $(START_DIR)/slprj/ert/_sharedutils/rtGetNaN.c $(START_DIR)/slprj/ert/_sharedutils/rt_nonfinite.c $(START_DIR)/slprj/ert/_sharedutils/rt_roundd_snf.c $(START_DIR)/slprj/ert/_sharedutils/rt_powf_snf.c $(START_DIR)/slprj/ert/_sharedutils/rt_atan2d_snf.c
...
OBJS = const_params.o rtGetInf.o rtGetNaN.o rt_nonfinite.o rt_roundd_snf.o rt_powf_snf.o rt_atan2d_snf.o
...
rt_atan2d_snf.o : $(START_DIR)/slprj/ert/_sharedutils/rt_atan2d_snf.c
	$(CC) $(CFLAGS) -o "$@" "$<"
