...
## Generated on : Mon May 27 08:50:58 2019
## MATLAB Coder version: 4.2 (R2019a)
## 
## Build Info:
## 
## Final product: ./flightControllerPID_rtwlib.a
...
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
MODELLIB                  = flightControllerPID_rtwlib.a
...
PRODUCT = ./flightControllerPID_rtwlib.a
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(START_DIR)/slprj/ert/flightControllerPID -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(START_DIR)/slprj/ert/_sharedutils -I/home/cerlabcontrol/Documents/MATLAB/SupportPackages/R2019a/toolbox/target/supportpackages/parrot/include
...
SRCS = $(START_DIR)/slprj/ert/flightControllerPID/flightControllerPID.c
...
%.o : $(START_DIR)/slprj/ert/flightControllerPID/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/slprj/ert/flightControllerPID/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
