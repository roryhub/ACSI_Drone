...
typedef struct P_LQRController_T_ P_LQRController_T;

/* Forward declaration for rtModel */
typedef struct tag_RTM_LQRController_T RT_MODEL_LQRController_T;

#endif                                 /* RTW_HEADER_LQRController_types_h_ */
