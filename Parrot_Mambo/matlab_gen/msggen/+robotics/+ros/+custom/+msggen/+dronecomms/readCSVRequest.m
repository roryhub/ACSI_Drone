classdef readCSVRequest < robotics.ros.Message
    %readCSVRequest MATLAB implementation of dronecomms/readCSVRequest
    ...
    properties (Constant)
        MessageType = 'dronecomms/readCSVRequest' % The ROS message type
    end
    ...
    methods
        function obj = readCSVRequest(msg)
            %readCSVRequest Construct the message object readCSVRequest
        ...
        function set.Filename(obj, filename)
            ...
            validateattributes(filename, {'char', 'string'}, {}, 'readCSVRequest', 'Filename');
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?robotics.ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = robotics.ros.custom.msggen.dronecomms.readCSVRequest.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = robotics.ros.custom.msggen.dronecomms.readCSVRequest;
            obj.reload(strObj);
        end
    end
end
