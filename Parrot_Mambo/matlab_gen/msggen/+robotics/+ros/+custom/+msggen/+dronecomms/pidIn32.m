classdef pidIn32 < robotics.ros.Message
    %pidIn32 MATLAB implementation of dronecomms/pidIn32
    ...
    properties (Constant)
        MessageType = 'dronecomms/pidIn32' % The ROS message type
    end
    ...
    methods
        function obj = pidIn32(msg)
            %pidIn32 Construct the message object pidIn32
        ...
        function set.Data(obj, data)
            ...
            validateattributes(data, {'numeric'}, {'vector'}, 'pidIn32', 'Data');
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?robotics.ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = robotics.ros.custom.msggen.dronecomms.pidIn32.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = robotics.ros.custom.msggen.dronecomms.pidIn32;
            obj.reload(strObj);
        end
    end
end
