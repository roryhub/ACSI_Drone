classdef droneOut32 < robotics.ros.Message
    %droneOut32 MATLAB implementation of dronecomms/droneOut32
    ...
    properties (Constant)
        MessageType = 'dronecomms/droneOut32' % The ROS message type
    end
    ...
    methods
        function obj = droneOut32(msg)
            %droneOut32 Construct the message object droneOut32
        ...
        function set.Data(obj, data)
            ...
            validateattributes(data, {'numeric'}, {'vector'}, 'droneOut32', 'Data');
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?robotics.ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = robotics.ros.custom.msggen.dronecomms.droneOut32.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = robotics.ros.custom.msggen.dronecomms.droneOut32;
            obj.reload(strObj);
        end
    end
end
